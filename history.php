...
<link href="https://fonts.googleapis.com/css2?family=Dongle&family=Open+Sans:wght@500&family=Outfit:wght@300;400&family=Varela+Round&display=swap" rel="stylesheet">
    <style>
...
<body>
    <div style="font-family: 'Dongle', sans-serif;   font-size: 70px;
        text-align: center;
        margin: 20px;
